...
import com.app.chliguiy.data.AppConfig;
import com.app.chliguiy.data.DatabaseHandler;
import com.app.chliguiy.data.SharedPref;
import com.app.chliguiy.fragment.FragmentCategory;
import com.app.chliguiy.fragment.FragmentFeaturedNews;
...
public class ActivityMain extends AppCompatActivity {
    ...
    public boolean onItemSelected(int id) {
        ...
        switch (id) {
            ...
            case R.id.nav_history:
                i = new Intent(this, ActivityClient.class);
                startActivity(i);
                break;
            ...
            case R.id.nav_news:
                ...
                break;
            case R.id.nav_stock:
                i = new Intent(this, ActivityStock.class);
                startActivity(i);
                break;
            case R.id.nav_frais:
                i = new Intent(this, ActivityFrais.class);
                startActivity(i);
                break;
            case R.id.nav_plan:
                i = new Intent(this, ActivityPlan.class);
                startActivity(i);
                break;
            case R.id.nav_privision:
                i = new Intent(this, ActivityPrevision.class);
                startActivity(i);
                break;
            case R.id.nav_rapport:
                i = new Intent(this, ActivityRapport.class);
                startActivity(i);
                break;
    ...
    private void updateNavCounter(NavigationView nav) {
       ...
       // ((TextView) menu.findItem(R.id.nav_cart).getActionView().findViewById(R.id.counter)).setText(String.valueOf(cart_count));
        ...
        MenuItem dot_connexion = menu.findItem(R.id.nav_wish);
        MenuItem dot_logout = menu.findItem(R.id.nav_logout);

    MenuItem dot_client =  menu.findItem(R.id.nav_history);

        MenuItem dot_stock =  menu.findItem(R.id.nav_stock);
        ;
        MenuItem dot_frais= menu.findItem(R.id.nav_frais);

        MenuItem dot_plan =  menu.findItem(R.id.nav_plan);

        MenuItem dot_privision =  menu.findItem(R.id.nav_privision);
        ;
        MenuItem dot_rapport = menu.findItem(R.id.nav_rapport);

        if(sharedPref.getIdUser()==null){

            dot_connexion.setVisible(true);
            dot_stock.setVisible(false);
        dot_client.setVisible(false);
            dot_logout.setVisible(false);
            dot_frais.setVisible(false);
            dot_plan.setVisible(false);
            dot_privision.setVisible(false);
            dot_rapport.setVisible(false);

        }else{
            dot_frais.setVisible(true);
            dot_plan.setVisible(true);
            dot_privision.setVisible(true);
            dot_rapport.setVisible(true);
            dot_stock.setVisible(true);
            dot_client.setVisible(true);
           dot_logout.setVisible(true);
            dot_connexion.setVisible(false);
        }
