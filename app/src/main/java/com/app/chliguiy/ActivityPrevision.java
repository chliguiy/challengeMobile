...
public class ActivityPrevision extends AppCompatActivity {
    ...
    private TextInputLayout ville_lyt, comment_lyt;
    private EditText ville, comment;
    ...
    private void iniComponent() {
        ...
        progressDialog = new ProgressDialog(ActivityPrevision.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item_id == android.R.id.home) {
            ...
            Intent   i = new Intent(this, ActivityPrevisionList.class);
    ...
    private void submitForm() {
        ...
        if(!validecomment()){
            Snackbar.make(parent_view, R.string.invalid_modification, Snackbar.LENGTH_SHORT).show();
            return;
        }
        if(!valideville()){
    ...
    private void submitOrderData() {
        ...
        PrivisionDeplacement privisionD = new PrivisionDeplacement();
        Privision privision=new Privision();
        privision.date=date_shipping.getText().toString();
        privision.user_id=sharedPref.getIdUser();
        privision.modification=comment.getText().toString();
        privision.ville=ville.getText().toString();
        privisionD.privision=privision;

        API api = RestAdapter.createAPI();
        callbackCall = api.submitprevision(privisionD);
    ...
    public void dialogSuccess(String code) {
        ...
        Dialog dialog = new DialogUtils(this).buildDialogInfo(
                ...
                "Ajoute d'un Prévision  avec succées.",
